<template>
    <div id="app" style=" background-color: #d4d4d4;">
      <nav class="navbar">
        <div class="navbar-logo">
          <a href="#"><img src="../assets/logo-w.png" alt="Logo" class="logo"></a>
        </div>
      ...
      <div class="content">
        ...
        <div class="info-panel" v-if="selectedProvince">
          <h2>{{ getSelectedProvinceName }}</h2>
          <p>Studio de {{ getSelectedProvinceName }} <a href="#">ici.</a></p>
        </div>
      </div>
    </div>
  </template>
  ...
  methods: {
    ...
    getProvinceColor(id) {
      if (this.selectedProvince === id) return 'red'
      if (this.highlightedProvince === id) return 'orange'
      return '#464646'
    }
  }
}
